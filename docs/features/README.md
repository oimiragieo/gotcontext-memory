...
Deep dives into each subsystem. Read [concepts/mental-model.md](../concepts/mental-model.md)
first if these names are unfamiliar.

| Doc | Subsystem |
|---|---|
| [memory-store.md](./memory-store.md) | Sole writer, CAS, locks, revisions |
| [secrets.md](./secrets.md) | Credential gate + allowlist |
...
| [portability.md](./portability.md) | Export/import archives |
| [mcp.md](./mcp.md) | Thin JSON-RPC tools |
